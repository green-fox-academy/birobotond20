...
public class ConnectTheDots {
    public static void mainDraw(Graphics graphics) {
        ...
        int[][] coordinates1 = {{10, 10}, {290,  10}, {290, 290}, {10, 290}};
        int[][] coordinates2 = {{50, 100}, {70, 70}, {80, 90}, {90, 90}, {100, 70},
                {120, 100}, {85, 130}, {50, 100}};

        draw(coordinates1, graphics);
        draw(coordinates2, graphics);
    }

    private static void draw(int[][] coordinates, Graphics graphics){
